...
export default function HWBirth({ route }) {
...
console.log('Email: ',itemId);
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.heading}>Healthcare Worker</Text>
      <Text style={styles.heading1}>Dashboard</Text>
      <View style={styles.card}>
      <Text style={styles.heading2}>WELCOME</Text>
      <Text style={styles.body}>You can add and view the details of vaccine records and birth records in this dashboard.</Text>
        ...
        <View style={styles.horizontalContainer}>
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('HWBirthData')}
          >
